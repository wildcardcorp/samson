...
import io
import struct
from samson.utilities import left_rotate, md_pad
...
class Sha1Hash(object):
    ...
    def _produce_digest(self, fakeLen=None):
        ...
        #message_byte_length if fakeLen is None else fakeLen
        message = md_pad(message, self._message_byte_length + len(message), byteorder='big')
