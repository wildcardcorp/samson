...
from samson.math.general import pohlig_hellman, random_int
...
class DiffieHellman(EncodablePKI):
    """
    ...
    def __init__(self, g: int=2, p: int=MODP_2048, q: int=None, key: int=None):
        """
        Parameters:
            key (int): Secret key.
            g   (int): Exponent base.
            ...
            q   (int): Order.
        """
        self.key = key or max(2, random_int(q or p))
        self.g = g
        self.p = p
        self.q = q
