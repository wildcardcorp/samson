...
from samson.encoding.openssh.openssh_ecdsa_private_key import seriailize_public_point
...
class SSH2ECDSAPublicKey(OpenSSHECDSAPublicKey):
    ...
    def encode(ecdsa_key: object):
        ...
        encoded, _, _, _ = generate_openssh_public_key_params(PKIEncoding.SSH2, b'ecdsa-sha2-' + curve, public_key)
