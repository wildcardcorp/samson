...
# Grey Wolf optimizer:
# nWolves:	number of wolves to spawn
# nIters:	number of iterations to run
# boundsMat:	px2 matrix of parameters to optimize
...
class GreyWolfOptimizer:
  ...
  def run(self):
    ...
    # Sort wolves
    # self.bestWolves[self.bestWolves[:, numParams].argsort()][::-1]
    self.bestWolves = self.bestWolves[self.bestWolves[:, numParams].argsort()]#[::-1]
    return i
