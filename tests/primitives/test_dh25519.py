...
class DH25519TestCase(unittest.TestCase):
    def _run_test(self, curve, key_a, key_b, expected_pub_a=None, expected_pub_b=None, expected_shared_key=None):
        dh_a = DH25519(key=key_a, curve=curve)
        dh_b = DH25519(key=key_b, curve=curve)

        pub_a = dh_a.get_challenge()
        pub_b = dh_b.get_challenge()
    ...
    def test_vec0(self):
        ...
        expected_shared_key = Bytes(0x4A5D9D5BA4CE2DE1728E3BF480350F25E07E21C947D19E3376F09B3C1E161742)[::-1].int()
    ...
    def test_vec1(self):
        ...
        expected_shared_key = Bytes(0x07FFF4181AC6CC95EC1C16A94A0F74D12DA232CE40A77552281D282BB60C0B56FD2464C335543936521C24403085D59A449A5037514A879D)[::-1].int()
