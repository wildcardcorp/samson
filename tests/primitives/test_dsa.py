...
class DSATestCase(unittest.TestCase):
    ...
    def test_openssh_gauntlet(self):
        ...
        for i in range(num_runs):
            ...
            priv        = dsa.export_private_key(encoding='OpenSSH', encryption=b'aes256-ctr', passphrase=passphrase)
            pub_openssh = dsa.export_public_key(encoding='OpenSSH')
            pub_ssh2    = dsa.export_public_key(encoding='SSH2')
            ...
            self.assertTrue((new_priv.p, new_priv.q, new_priv.g, new_priv.x, new_priv.y), (dsa.p, dsa.q, dsa.g, dsa.x, dsa.y))
            self.assertTrue((new_pub_openssh.p, new_pub_openssh.q, new_pub_openssh.g, new_pub_openssh.y), (dsa.p, dsa.q, dsa.g, dsa.y))
            self.assertTrue((new_pub_ssh2.p, new_pub_ssh2.q, new_pub_ssh2.g, new_pub_ssh2.y), (dsa.p, dsa.q, dsa.g, dsa.y))
